 ...
 * TypedPatternEngine -> PatternCompiler -> CompiledPattern -> match/generate
 * Tests behavior, not implementation details
 */
class PatternEngineIntegrationTest extends TestCase
{
    ...
    {
        yield 'non-numeric-string-to-int' => ['PAGE{uid:int}', ['uid' => 'a1b2c'], PatternEngineInvalidArgumentException::class];
        yield 'non-numeric-string-to-int-alpha' => ['PAGE{uid:int}', ['uid' => 'abc'], PatternEngineInvalidArgumentException::class];
        yield 'mixed-alphanumeric-to-int' => ['ID{code:int}', ['code' => '123abc'], PatternEngineInvalidArgumentException::class];
        yield 'float-string-to-int' => ['PAGE{uid:int}', ['uid' => '123.45'], PatternEngineInvalidArgumentException::class];
        yield 'boolean-to-int' => ['PAGE{uid:int}', ['uid' => true], PatternEngineInvalidArgumentException::class];
        yield 'array-to-int' => ['PAGE{uid:int}', ['uid' => [123]], PatternEngineInvalidArgumentException::class];
        yield 'null-to-int' => ['PAGE{uid:int}', ['uid' => null], PatternEngineInvalidArgumentException::class];
    }
